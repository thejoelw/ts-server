...
template <typename Consumer> class Compressor : public Consumer {
public:
  ...
  Compressor(ConsumerArgs... args)
    ...
    //        checkZstdRes(ZSTD_CCtx_setParameter(context, ZSTD_c_compressionLevel,
    //        ZSTD_minCLevel()));
  ...
  std::size_t getPrefferedSize() const { return ZSTD_CStreamInSize(); }
